# 🚀 API Performance Tracer (.NET)

A lightweight, developer-focused tool that helps you understand **where your API time is being spent** — before production.

Think of it as a **“Lighthouse for APIs”** — providing a simple breakdown of request latency across the backend pipeline.
...
├─ Controller Execution: 140ms
└─ Response Pipeline: 170ms

yaml
Copy code

Instead of only seeing *“this request took 320ms”*, the tool helps you understand **why** it took that long and where bottlenecks exist.

---

## 🧩 Phase 1 — MVP Scope

### ✅ Step 1 — Request Timing Middleware (Core)
...
### ⏳ Step 2 — Database Timing (EF Core first)
...
### ⏳ Step 4 — Simple Web UI Viewer (Future)
...
api-perf/
├─ ApiPerfDemo/ # Sample API using the tool
├─ ApiPerf.Core/ # Library with middleware + tracers
├─ ApiPerf.CLI/ # (future) CLI API test runner
└─ README.md
...
- ⚡ Developer-first  
- 🧩 Zero-config setup  
- 🛠️ Works locally & in CI  
- 🧪 Focused on pre-production debugging  
- 👐 Open-source & extensible  
- 🏗️ Lightweight — not a full APM tool  
...
- ✔️ Environment setup  
- ⏳ Step 1 — Request Timing Middleware  
...
Early-stage community project — contributors welcome.
...
Follow along, experiment, test, and help make API optimization easier for everyone 🚀
